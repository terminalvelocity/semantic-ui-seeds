...
[![Join the chat at https://gitter.im/terminalvelocity/seeds.js](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/terminalvelocity/seeds.js?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge) ![Downloads on NPM](http://img.shields.io/npm/dm/semantic-ui-seeds.svg?style=flat-square)
...
## Installation
`ember install semantic-ui-seeds`

or

`npm install -g semantic-ui-seeds`
